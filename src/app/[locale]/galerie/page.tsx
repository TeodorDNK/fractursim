...
    locale,
    pathname: "/galerie",
    title: t.gallery?.title ?? "Galerie – Fracturism",
    description:
      t.gallery?.subtitle ??
      "Lucrări selectate și poveștile lor.",
  });
}
...
  return (
    // Container părinte: Folosim Flexbox pentru coloane
    <div className="min-h-screen w-full flex bg-[#1a404d] text-zinc-200">
      
      <FrameColumn position="left" />

      {/* Noul container centrat, optimizat pentru mobil și desktop */}
      <div className="w-full max-w-4xl mx-auto flex-grow lg:flex-none">
        <div className="w-full bg-transparent"> 
          <JsonLd data={jsonld} />

          {/* Titlul principal al paginii, RĂMÂNE CENTRAT pentru un aspect de antet */}
          <header className="py-10 px-6 md:py-16 text-center">
            <h1 className="font-[var(--font-arhaic)] text-4xl md:text-5xl mb-3"> 
              {title}
            </h1>
            <p className="font-serif text-base md:text-lg text-zinc-300 mt-2 max-w-2xl mx-auto"> 
              {dek}
            </p>
          </header>
...
          <footer className="py-8 md:py-12 border-t border-white/20"> 
            <div className="text-center max-w-4xl mx-auto px-6">
              <p
                className="font-[var(--font-arhaic)] text-xl" 
